...
Once the `conda-forge` channel has been enabled, `xeofs` can be installed with:

```
conda install xeofs
```

It is possible to list all of the versions of `xeofs` available on your platform with:
